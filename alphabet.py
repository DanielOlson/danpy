...
amino_n_to_a = [c for c in 'ARNDCQEGHILKMFPSTWYVBZXJ*UO']
amino_a_to_n = {c: i for i, c in enumerate('ARNDCQEGHILKMFPSTWYVBZXJ*UO')}
...
amino_n_to_v[amino_a_to_n['O']] = amino_frequencies
